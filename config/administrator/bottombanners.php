...
//                    array(220, 138, 'fit', public_path() . '/uploads/products/thumbs/medium/', 100),
                array(1000, 100, 'crop', public_path() . '/assets/banners/subbanners/', 100),
                array(500, 50, 'landscape', public_path() . '/assets/banners/subbanners/thumbs/', 100)
            )
        )
