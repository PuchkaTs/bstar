<div class="simpleCart_shelfItem col-md-3 col-sm-6 textcenter">
@if($product->sale)
        ...
        <div class="info">
            <div class="row">
                ...
                <div class="price">
                    ...
                    @if($product->sale)                  
                        <h5 class="price-text-color item_price"><span class="oldprice">{{$product->oldprice}}₮</span> <span class="item_price">{{$product->price}}₮</span></h5>  
                    @else                    
